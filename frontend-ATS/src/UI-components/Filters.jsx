...
const Filters = ({ allJobs, setFilteredJobs, AI_DICT }) => {
  ...
  const parseRelativeDate = (otherInfo) => {
    ...
    // Find string matching "X days ago"
    ...
    // Extract number of days (e.g., "17" from "17 days ago")
...
//               let temp_list = [];
//               selectedJobTitles.forEach((value) => temp_list.push(value));
...
//               console.log("selectedJobTitles: ", temp_list);
//             }}
//             className="h-4 w-4 text-blue-500 focus:ring-blue-500"
//           />
//           <span>{title}</span>
...
//       <h3 className="text-lg font-semibold mt-4 mb-2">Country</h3>
//       <select
//         className="w-full p-2 bg-gray-700 text-white border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
//         value={selectedCountry}
//         onChange={(e) => {
//           setSelectedCountry(e.target.value);
//           console.log("selectedCountry: ", e.target.value);
